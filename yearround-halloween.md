...
<style>
  .jumbotron {
    background: url(/img/yearround/halloween.png) center no-repeat;
...
<div class="jumbotron jumbotron-fluid">
    ...
    <div class="text-center">
      <h1 class="text-white">HALLOWEEKEND AT RESICA FALLS</h1>
    </div>
  </div>
...
<div class="container">
  <div class="row my-5">
    <div class="col text-center">
      <div class="subheader-text text-secondary">A WEEKEND OF SCARY FUN!</div>
      <div class="header-text text-primary">MORE INFORMATION AND <br> REGISTRATION COMING SOON!</div>
      <br>
      <br>
    </div>
  </div>
